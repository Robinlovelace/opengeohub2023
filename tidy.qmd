...
A work in progress is `rsgeo`, which provides an interface between R and the `geo` Rust crate.
This also opens up the possiblity of calling other high-performance Rust libraries from R.
