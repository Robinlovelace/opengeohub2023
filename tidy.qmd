...
3.  Create a new data frame called `countries_modified2` that contains the name, population and area of countries with a population density of more than 100 people per km2, sorted by area in descending order.
4.  Do the same with base R functions and the `[` operator.
