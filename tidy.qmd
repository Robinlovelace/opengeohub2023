...
You can use the `stretch` argument to stretch the values and avoid errors caused by outliers.
...
Plotting a RGB raster layer with terra, with outliers removed with `clamp()` (left) and manually (right)
